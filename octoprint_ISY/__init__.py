    ...
    def get_update_information(self):
        return dict(
            ISY=dict(
                ...
                pip="https://github.com/tjjfvi/OctoPrint-ISY/archive/{target_version}.zip"
            )
        )

__plugin_name__ = "OctoPrint-ISY"
__plugin_pythoncompat__ = ">=2.7,<4"


def __plugin_load__():
    global __plugin_implementation__
    __plugin_implementation__ = ISYplugin()
